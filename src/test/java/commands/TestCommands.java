...
public class TestCommands {
    ...
    public void testMathCommandInvalidExpression() {
        ...
        verify(rexCord, times(1))
                .sendMessage(channel, String.format("Expression is invalid!\nExpression:%s", input));
    }
    ...
    public void testMathCommandExpression() {
        ...
        command.runCommand(event, input);
        verify(rexCord, times(1))
                .sendMessage(eq(channel), contains("1+1=2"));
    }
    ...
    public void testAboutCommand() {
        ...
        verify(rexCord, times(1))
                .sendEmbeddedMessage(eq(channel), anyObject());
    }
    ...
    public void testHelloCommand() {
        ...
        command.runCommand(event, "");
        verify(rexCord, times(1))
                .sendMessage(eq(channel), contains("test-user"));
    }
    ...
    public void testRemindCommandFail() {
        ...
        verify(rexCord, times(1))
                .sendMessage(eq(channel), eq("Message not detected"));
    }
    ...
    public void testRemindCommandQueryFail() {
        ...
        verify(rexCord, times(1))
                .sendMessage(eq(channel), eq("Could not interpret query :("));
    }
    ...
    public void testRemindCommand() {
        ...
        verify(rexCord, times(1))
                .sendMessage(eq(channel), contains("Ok, I'll remind you"));
    }
    ...
    public void testUptimeCommand() {
        ...
        command.runCommand(event, "");
        verify(rexCord, times(1))
                .sendMessage(eq(channel), contains("RexCord has been sleep deprived for "));
    }
